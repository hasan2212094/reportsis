...
@section('title, Edit Direct Cost Actual')
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">From /</span>Edit Direct Cost Actual</h4>
        <div class="card-body">
            @if (session('error'))
            ...
            <form action="{{ route('page.directa.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row g-2">
                    <div class="col-md-2">
