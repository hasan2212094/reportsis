...
@section('title, Edit PPN Actual')
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">From /</span>Edit PPN Actual</h4>
        <div class="card-body">
            <form action="{{ route('page.ppna.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row g-2">
                    <div class="col-md-2">
                ...
                <div class="card-footer d-flex justify-content-end gap-3">
                    <a href="{{ route('page.ppna.index') }}" class="btn btn-dark"><i
