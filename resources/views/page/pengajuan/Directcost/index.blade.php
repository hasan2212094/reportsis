...
@section('content')
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <hr>
                        <p>📄 Contoh format file: <a href="{{ asset('template_directp_import.xlsx') }}" download>Download
                                Template</a></p>
                    </div>
    ...
    <ul class="nav nav-tabs mb-3" id="dataTab" role="tablist">
        <li class="nav-item">
            <button class="nav-link active" id="aktif-tab" data-bs-toggle="tab" data-bs-target="#aktif" type="button">Data
                Aktif</button>
        </li>
        <li class="nav-item">
                                ...
                                <td>
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <form class="form-soft-delete"
                                            action="{{ route('page.Directcost.destroy', $directcost->id) }}" method="POST"
                                            data-id="{{ $directcost->id }}">
                                            @csrf
                                            @method('DELETE')
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <form class="form-restore"
                                            action="{{ route('page.Directcost.restore', $directcost->id) }}" method="POST"
                                            data-id="{{ $directcost->id }}">
                                            @csrf
