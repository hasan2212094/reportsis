...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">From /</span>Add PPN Pengajuan</h4>
        <div class="card-body">
            @if (session('error'))
        ...
        <div class="card-footer d-flex justify-content-end gap-3">
            <a href="{{ url('/ppn') }}" class="btn btn-dark"><i class="icon-base bx bx-arrow-back icon-sm me-1"></i>
                Back to list</a>
