...
@section('title, Edit Indirect Cost Pengajuan')
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">From /</span>Edit Indirect Cost Pengajuan</h4>
        <div class="card-body">
            @if (session('error'))
            ...
            <form action="{{ route('page.indirectp.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row g-2">
                    <div class="col-md-1">
